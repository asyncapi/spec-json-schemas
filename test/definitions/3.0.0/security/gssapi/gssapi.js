...
describe('GSS-API', () => {
  it('empty', () => {
    ...
    assert(validationResult === false, 'GSS-API with empty body is not valid');
  ...
  it('only required properties', () => {
    ...
    assert(validationResult === true, 'GSS-API is valid with only required properties');
  });
  ...
  it('extended', () => {
    ...
    assert(validationResult === true, 'GSS-API can be extended');
  });
  ...
  it('wrongly extended', () => {
    ...
    assert(validationResult === false, 'GSS-API is not valid when was wrongly extended');
