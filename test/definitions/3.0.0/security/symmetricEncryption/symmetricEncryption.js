...
describe('Symmetric Encryption', () => {
  ...
  it('empty', () => {
    ...
    assert(validationResult === false, 'Symmetric Encryption with empty body is not valid');
  ...
  it('without required properties', () => {
    ...
    assert(validationResult === false, 'Symmetric Encryption without required properties is not valid');
    assert(validator.errors[0].message === 'must have required property \'type\'');
    assert(validator.errors.length === 1);
  });
  ...
  it('only required properties', () => {
    ...
    assert(validationResult === true, 'Symmetric Encryption is valid with only required properties');
  });
  ...
  it('extended', () => {
    ...
    assert(validationResult === true, 'Symmetric Encryption can be extended');
  });
  ...
  it('wrongly extended', () => {
    ...
    assert(validationResult === false, 'Symmetric Encryption is not valid when was wrongly extended');
