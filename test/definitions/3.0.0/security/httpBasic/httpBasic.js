...
describe('HTTP Basic', () => {
  ...
  it('empty', () => {
    ...
    assert(validationResult === false, 'HTTP Basic with empty body is not valid');
    assert(validator.errors[0].message === 'must NOT be valid');
    assert(validator.errors[1].message === 'must have required property \'scheme\'');
    assert(validator.errors[2].message === 'must have required property \'type\'');
  ...
  it('without required properties', () => {
    ...
    assert(validationResult === false, 'HTTP Basic without required properties is not valid');
    assert(validator.errors[0].message === 'must NOT be valid');
    assert(validator.errors[1].message === 'must have required property \'scheme\'');
    assert(validator.errors[2].message === 'must have required property \'type\'');
    assert(validator.errors.length === 3);
  ...
  it('only required properties', () => {
    ...
    assert(validationResult === true, 'HTTP Basic is valid with only required properties');
  });
  ...
  it('extended', () => {
    ...
    assert(validationResult === true, 'HTTP Basic can be extended');
  });
  ...
  it('wrongly extended', () => {
    ...
    assert(validationResult === false, 'HTTP Basic is not valid when was wrongly extended');
