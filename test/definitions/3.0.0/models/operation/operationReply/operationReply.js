...
const title = 'Operation Reply';
const validator = TestHelper.validator(require('@definitions/3.0.0/operationReply.json'));

describe.skip(`${title}. uri-reference not compatible with #/components/...`, () => {
  it('example', () => {
