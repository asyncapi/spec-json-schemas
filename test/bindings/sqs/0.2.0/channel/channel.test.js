...
const title = 'Channel'
const validator = TestHelper.validator(require('@bindings/sqs/0.2.0/channel.json'))
...
describe(`${title}`, () => {
  ...
  it('empty', () => {
    ...
    assert(validator.errors[0].message === 'must have required property \'queue\'');
  ...
  it.skip('extended. TODO: Can be extended or not?', () => {
  ...
  it.skip('wrongly extended. TODO: Can be extended or not?', () => {
