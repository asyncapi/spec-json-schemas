...
const title = 'Server'
const validator = TestHelper.validator(require('@bindings/jms/0.0.1/server.json'))
...
describe(`${title}`, () => {
  ...
  it('empty', () => {
    ...
    assert(validator.errors[0].message === 'must have required property \'jmsConnectionFactory\'');
