...
const title = 'Channel'
const validator = TestHelper.validator(require('@bindings/googlepubsub/0.1.0/channel.json'))
...
describe(`${title}`, () => {
  ...
  it('empty', () => {
    ...
    assert(validator.errors[0].message === 'must have required property \'schemaSettings\'');
    assert(validator.errors[1].message === 'must have required property \'topic\'');
